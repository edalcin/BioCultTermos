...
| **Campo Semântico** | O conjunto de conceitos que vieram do mesmo campo de origem do BioCultDB; tecnicamente, o array `sourceFields` do conceito. Um conceito pode pertencer a mais de um. São **quatro** os campos existentes: `comunidades.tipo`, `comunidades.plantas.nomeVernacular`, `comunidades.plantas.tipoUso`, `comunidades.atividadesEconomicas`. Nome científico **não é** Campo Semântico — saiu do vocabulário em 2026-08-10 ([§7.3](07-guia-de-decisao.md#s7-3)). |
